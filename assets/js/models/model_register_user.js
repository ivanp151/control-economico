...
var Routers = Backbone.Router.extend({
        ...
        /*$jquery.getJSON(
            ...
            function(data){
                ...
                if(data.success){
                    ...
                    jsonResponse = data;
                    register.render("#newIncome",jsonResponse);
                }
                else{
                    register.addIncome();
        ...
        $jquery.getJSON(
            ...
            function(data){
                ...
                if(data.success){
                    //jsonResponse = {"success":true,"data":[{"id":1,"concepto":"Inversión"},{"id":2,"concepto":"Sueldo"}],"msj":""};
                    jsonResponse = data;
                    register.render("#resumeIncome",jsonResponse);
                    //register.render("#newIncome",jsonResponse);
                }
                else{
                    register.addIncome();
    ...
    ****************************************************/
    graphIncomes : function(){
        register.render("#graph-incomes",jsonResponse);
    }
});
